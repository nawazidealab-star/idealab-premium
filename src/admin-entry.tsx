...
export default function AdminEntry() {
  ...
  if (authenticated) return <><InvoiceBuilderSupport/><InvoicePdfSupport/><ContentExcelAutomation/><AdminChatV4/><AdminControlsV6/><ContentPlannerV8/><TasksWorkspaceV10/><AdminAppV4/></>;
